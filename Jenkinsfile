node {
  ...
  sh("docker build -t registry.aliyuncs.com/xiaolu-img/xiaolusys-ui:${env.BRANCH_NAME} .")
  sh("docker push registry.aliyuncs.com/xiaolu-img/xiaolusys-ui:${env.BRANCH_NAME}")
