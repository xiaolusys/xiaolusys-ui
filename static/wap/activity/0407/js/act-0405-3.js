        ...
        if (envNum <= 8 && envNum > 0) {
          ...
          for (var i = 0; i < envNum; i++) {
            ...
            if (envelopes[i].status === 'open' && envelopes[i].type === 'card') {
              ...
              h.push('<p>拼图</p>');
            } else if (envelopes[i].status === 'open' && envelopes[i].type === 'cash') {
              ...
              h.push('<img class="act-icon act-evelop" src="../img/act-0405-27.png" data-id = "' + envelopes[i].id + '" data-status="' + envelopes[i].status + '"/>');
              h.push('<p>未拆开</p>');
            }
            h.push('</div>');
          }
